...
--Purpose		: Data updation in Table GigStatusMaster
--Date			: 23 Jan 2019
--Created By	: Sanu Mohan

IF (EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES  WHERE  TABLE_NAME = 'GigStatusMaster'))
BEGIN
	
	IF (NOT EXISTS (SELECT 1 FROM GigStatusMaster WHERE GigStatusFlag = 'R'))
	BEGIN
		INSERT INTO GigStatusMaster VALUES ('R','Review')
	END	
	IF (NOT EXISTS (SELECT 1 FROM GigStatusMaster WHERE GigStatusFlag = 'P'))
	BEGIN
		INSERT INTO GigStatusMaster VALUES ('P','Posted')
	END	
	IF (NOT EXISTS (SELECT 1 FROM GigStatusMaster WHERE GigStatusFlag = 'F'))
	BEGIN
		INSERT INTO GigStatusMaster VALUES ('F','Failed')
	END	
END
...
IF (EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES  WHERE  TABLE_NAME = 'GigSubscriptionStatusMaster'))
BEGIN
	
	IF (NOT EXISTS (SELECT 1 FROM GigSubscriptionStatusMaster WHERE GigSubscriptionStatusFlag = 'S'))
	BEGIN
		INSERT INTO GigSubscriptionStatusMaster VALUES ('S','Subscribed')
	END	
	IF (NOT EXISTS (SELECT 1 FROM GigSubscriptionStatusMaster WHERE GigSubscriptionStatusFlag = 'A'))
	BEGIN
		INSERT INTO GigSubscriptionStatusMaster VALUES ('A','Approved')
	END	
	IF (NOT EXISTS (SELECT 1 FROM GigSubscriptionStatusMaster WHERE GigSubscriptionStatusFlag = 'J'))
	BEGIN
		INSERT INTO GigSubscriptionStatusMaster VALUES ('J','Job')
	END	
	IF (NOT EXISTS (SELECT 1 FROM GigSubscriptionStatusMaster WHERE GigSubscriptionStatusFlag = 'R'))
	BEGIN
		INSERT INTO GigSubscriptionStatusMaster VALUES ('R','Rejected')
	END	
END