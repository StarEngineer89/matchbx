   ...
   public class GigSubscriptionModel : DBContext
    {
        ...
        public List<GigSubscription> GetGigSubscriptions(GigSubscription _obj)
        {
            return base.GetCustomFunction<GigSubscription>("spGetGigSubscription ", _obj);
        }
        public List<GigSubscription> GetActiveOrders(GigSubscription _obj)
        {
            return base.GetCustomFunction<GigSubscription>("spGetActiveGigSubscription", _obj);
        }
        public List<GigSubscription> GetCompletedOrders(GigSubscription _obj)
        {
            return base.GetCustomFunction<GigSubscription>("spGetCompletedGigSubscription", _obj);
        }
    }
}
